...
class RoadGraphics(object):
    ...
    def display(road: Road, surface: WorldSurface) -> None:
        ...
        for k, v in laneletmap['way'].items():
        ...
        # for k, lane in laneletmap['lanes'].items():
        #     position = surface.vec2pix(lane['center_points'][0])
        #     font = pygame.font.Font(None, 15)
        #     # text = "#{}".format(id(v) % 1000)
        #     text = font.render(f'{k}'[-2:], 1, (10, 10, 10), None)
