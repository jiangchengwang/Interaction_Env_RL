...
from simulation_environment.common.action import (
    ActionType,
    ContinuousAction,
    DiscreteMetaAction,
)
from simulation_environment.osm_envs.road_graphics import RoadGraphics, WorldSurface
...
if TYPE_CHECKING:
    ...
    from simulation_environment.common.abstract import Action
...
class ObservationGraphics(object):
    ...
    def display(cls, obs, sim_surface):
        # from simulation_environment.common.observation import LidarObservation
        #
